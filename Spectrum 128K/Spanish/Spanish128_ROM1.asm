; **********************************************
; *** SPANISH SPECTRUM 128 ROM 1 DISASSEMBLY ***
; **********************************************
...
; ------------
; 24th May 2009
; Differences to the English Spectrum 128 ROM 0 are commented with ;- to signify a removal and ;+ to signify an addition.
...
;-      DEFB    'r'+$80                                 ; R
        ...
        DEFM    "NEXT SIN FO"
        DEFB    'R'+$80                                 ;+ 1
        DEFM    "VARIABLE INDEFINID"
        DEFB    'A'+$80                                 ;+ 2
        DEFM    "INDICE ERRONE"
        DEFB    'O'+$80                                 ;+ 3
        DEFM    "SIN MEMORI"
        DEFB    'A'+$80                                 ;+ 4
        DEFM    "FUERRA DE PANTALL"
        DEFB    'A'+$80                                 ;+ 5 - [*BUG* - Should be "FUERA DE PANTALLA"]
        DEFM    "NUMERO MUY ALT"
        DEFB    'O'+$80                                 ;+ 6
        ...
        DEFM    "SENTENCIA STO"
        DEFB    'P'+$80                                 ;+ 9
        DEFM    "ARGUMENTO ERRONE"
        DEFB    'O'+$80                                 ;+ A
        DEFM    "ENTERO FUERA DE RANG"
        DEFB    'O'+$80                                 ;+ B
        DEFM    "NO EXISTE EN BASI"
        DEFB    'C'+$80                                 ;+ C
        DEFM    "BREAK/CONT SIGU"
        DEFB    'E'+$80                                 ;+ D
        DEFM    "FALTAN DATO"
        DEFB    'S'+$80                                 ;+ E
        DEFM    "NOMBRE/FICHERO ERRONE"
        DEFB    'O'+$80                                 ;+ F
        DEFM    "NO HAY SITI"
        DEFB    'O'+$80                                 ;+ G
        DEFM    "STOP EN INPU"
        ...
        DEFM    "FOR SIN NEX"
        DEFB    'T'+$80                                 ;+ I
        DEFM    "DISPOSITIVO E/S ERRONE"
        DEFB    'O'+$80                                 ;+ J
        DEFM    "COLOR INVALID"
        DEFB    'O'+$80                                 ;+ K
        DEFM    "BREAK EN PROGRAM"
        DEFB    'A'+$80                                 ;+ L
        DEFM    "RAMTOP MAL"
        DEFB    'A'+$80                                 ;+ M
        DEFM    "SENTENCIA PERDID"
        DEFB    'A'+$80                                 ;+ N
        DEFM    "CORRIENTE INVALID"
        DEFB    'A'+$80                                 ;+ O
        DEFM    "FN SIN DE"
        DEFB    'F'+$80                                 ;+ P
...
;; KPD_TABLE1
L3B13:	DEFB $2E, $0D, $33, $32		;'.', ENTER, 3, 2
	DEFB $31			;1

;; KPD_TABLE2
L3B18:	DEFB $29, $28, $2A, $2F		;), (, *, /
	DEFB $2D, $39, $38, $37		;- , 9, 8, 7
	DEFB $2B			;+

;; KPD_TABLE3
L3B21:	DEFB $36, $35, $34, $30		;6, 5, 4, 0

;; KPD_TABLE4
L3B25:	DEFB $A5, $0D, $A6, $A7		;bottom, ENTER, top, end of line
...
L3BC9:  SCF     		;Return as if no trailing space ????????? Not sure does anything useful

	BIT     1,(IY+$01)	;Test if printer is in use
	RET     NZ		;NZ=printer in use (ignore if printer being used?)
...
L3BE1:	DEFB $00, $00, $00, $00	;Unused locations
	DEFB $00, $00, $00, $00
	DEFB $00, $00, $00, $00
	DEFB $00, $00, $00, $00
	DEFB $00, $00, $00, $00
...
L3C04:	DEFB $00, $00, $00, $00	;Unused locations
	DEFB $00, $00, $00, $00
	DEFB $00, $00, $00, $00
	DEFB $00, $00, $00, $00
	DEFB $00, $00, $00, $00

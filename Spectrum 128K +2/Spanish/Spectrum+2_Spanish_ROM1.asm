; *********************************************
; *** SPANISH SPECTRUM +2 ROM 1 DISASSEMBLY ***
; *********************************************
...
; ------------
; 24th May 2009
; Differences to the English Spectrum +2 ROM 0 are commented with ;- to signify a removal and ;+ to signify an addition.
...
;-      DEFM    "Press REC & PLAY, then any key"
        DEFM    "Pulse REC y PLAY, y luego tecl" ;+
L09C0:  DEFB    'a'+$80                          ;+
;-      DEFB    '.'+$80
        DEFB    $0D
        DEFM    "Program:"
